...
<div style="display:flex; justify-content:center; align-items:center; flex-wrap:wrap; gap:20px; max-width:45%;">
  ...
  <figure style="text-aligh:center;">
    <img src="/images/pulsersideways.png" alt="Technician holding Pulser Sideways to." width="40%"; height:350px;/>
