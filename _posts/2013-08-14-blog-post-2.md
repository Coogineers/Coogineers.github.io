...
## Constraint challenges to our design 
  ...
  * Weight vs. footprint: Supporting a 40 lb pulser within a 64 × 48 in bench space forces us to rethink how we distribute loads and control motion.
  * Lift and alignment: Achieving an 18 in vertical stroke with ±0.1 in positional accuracy means our actuator must be both powerful and precise with small room for drift or backlash.
...
<div style="display:flex; justify-content:center; align-items:center; flex-wrap:wrap; gap:20px; max-width:45%; height:350px;">
  <figure style="text-align:center;">
    <img src="/images/pulserontable.png" alt="Figure 1: Technician Holding Pulser fill hole above Vacuum." width="40%"; height:350px;/>
    <figcaption>Figure 1: Technician Holding Pulser above Vacuum.</figcaption>
    <img src="/images/pulsersideways.png" alt="Technician holding Pulser Sideways to " width="40%"; height:auto;/>
