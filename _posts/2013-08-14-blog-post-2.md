...
## Constraint challenges to our design 
  ...
  * Weight vs. footprint: Supporting a 40 lb pulser within a 64 × 48 in bench space forces us to rethink how we distribute loads and control motion. Figure 2 below, shows the pulser rod lifted onto the work bench to elevate the pulser fill hole above the degassing chamber.
  * Lift and alignment: Achieving an 18 in vertical stroke with ±0.1 in positional accuracy means our actuator must be both powerful and precise with small room for drift or backlash. Figure 3 below is an example of a technician rolling the pulser rod to assist the movement of trapped air pockets.
...
<div style="display:flex; justify-content:center; align-items:center; flex-wrap:wrap; gap:20px;">
  <figure style="text-align:center; max-width:45%;">
    ...
    <figcaption> Figure 2: Technician Holding Pulser above Vacuum .</figcaption>
  </figure>
  <figure style="text-align:center; max-width:45%;">
    <img src="/images/pulsersideways.png" alt="Pulser sideways" style="width:100%; height:auto;"/>
    <figcaption>Figure 3: Technician rolling tool manually.</figcaption>
  </figure>
</div>
