...
<div style="display: flex; justify-content: center; align-items: center; flex-wrap:wrap; gap:20px; height:auto;">
  <figure style="text-align: center;">
    <img src="/images/pulserontable.png" alt="Figure 1: Technician Holding Pulser fill hole above Vacuum." width="45%"; height:auto;/>
    <figcaption>Figure 1: Technician Holding Pulser above Vacuum.</figcaption>
  </figure>
  <figure style="text-align: center;">
    <img src="/images/pulsersideways.png" alt="Technician holding Pulser Sideways to " width="45%"; height:auto;/>
